    ...
    public class AndroidBuildProcess : IActiveBuildTargetChanged, IPreprocessBuildWithReport, IPostprocessBuildWithReport
    {
        ...
        private static void UpdateStringsXml()
        {
            ...
            if (s_settings.NotificationServicesSettings.IsEnabled)
            {
                ...
                config.Add("NOTIFICATION_SERVICES_BIG_PICTURE_KEY", s_settings.NotificationServicesSettings.AndroidProperties.PayloadKeys.BigPictureKey);
                config.Add("NOTIFICATION_SERVICES_LARGE_ICON_KEY", s_settings.NotificationServicesSettings.AndroidProperties.PayloadKeys.LargeIconKey);
                ...
                config.Add("NOTIFICATION_SERVICES_ALLOW_IN_EXACT_TIME_SCHEDULING", s_settings.NotificationServicesSettings.AndroidProperties.AllowInExactTimeScheduling ? "true" : "false");
            }
