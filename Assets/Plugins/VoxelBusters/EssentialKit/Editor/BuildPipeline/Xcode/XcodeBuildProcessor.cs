...
namespace VoxelBusters.EssentialKit.Editor.Build.Xcode
{
    public class XcodeBuildProcessor : IPreprocessBuildWithReport, IPostprocessBuildWithReport
    {
        ...
        public void OnPreprocessBuild(BuildReport report)
        {
            ...
            DebugLogger.Log(EssentialKitDomain.Default, "Initiating pre-build task execution.");
            ...
            DebugLogger.Log(EssentialKitDomain.Default, "Successfully completed pre-build task execution.");
        }
        ...
        public void OnPostprocessBuild(BuildReport report)
        {
            ...
            DebugLogger.Log(EssentialKitDomain.Default, "Initiating post-build task execution.");
            ...
            DebugLogger.Log(EssentialKitDomain.Default, "Successfully completed post-build task execution.");
        }
        ...
        {
            DebugLogger.Log(EssentialKitDomain.Default, "Updating plist configuration.");
