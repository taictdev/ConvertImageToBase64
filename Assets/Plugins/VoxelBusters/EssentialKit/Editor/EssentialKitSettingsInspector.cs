...
namespace VoxelBusters.EssentialKit.Editor
{
    ...
    public class EssentialKitSettingsInspector : SettingsObjectInspector
    {
        ...
        protected override ButtonInfo[] GetTopBarButtons()
        {
            ...
            {
                new ButtonInfo(label: "Documentation",  onClick: EssentialKitEditorUtility.OpenDocumentation),
                new ButtonInfo(label: "Tutorials",      onClick: EssentialKitEditorUtility.OpenTutorials),
                new ButtonInfo(label: "Forum",          onClick: EssentialKitEditorUtility.OpenForum),
                new ButtonInfo(label: "Discord",        onClick: EssentialKitEditorUtility.OpenSupport),
                new ButtonInfo(label: "Write Review",   onClick: () => EssentialKitEditorUtility.OpenAssetStorePage(true)),
            };
        }
        ...
        protected override PropertyGroupInfo[] GetPropertyGroups()
        {
            ...
            return new PropertyGroupInfo[]
            {
                ...
                new PropertyGroupInfo(reference: serializedObject.FindProperty("m_utilitySettings"),                displayName: "Utilities",               onDrawChildProperties: DrawUtilitySettingsProperty)
            };
        }
        ...
        protected override void DrawFooter()
        {
            ...
            if (!SettingsPropertyGroup.CanToggleFeatureUsageState())
            {
                ...
                {
                    SettingsPropertyGroup.UpdateBuildConfigurationToSupportToggleFeatureUsageState();
                }*/
            }
        ...
        private void DrawUtilitySettingsProperty(SerializedProperty property)
        {
            DrawChildProperties(property, ignoreProperties: "m_isEnabled");
